...
#top ten states
top_10_milk_cows_states <- milk_cows |> 
  arrange(number_of_cows) |> #sort increasing order
  head(10)  #top 10 rows

# table top ten states
knitr::kable(top_10_milk_cows_states, caption = "Top 10 States by Number of Cows")
```
head
