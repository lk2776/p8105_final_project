...
<div class="slideshow-container">
    ...
    <div class="slides">
        <img src="PSN/plot_1.png" style="width:100%">
    </div>

    <div class="slides">
        <img src="PSN/plot_2.png" style="width:100%">
    </div>

    <div class="slides">
        <img src="PSN/plot_3.png" style="width:100%">
    </div>

    <div class="slides">
        <img src="PSN/plot_4.png" style="width:100%">
    </div>
...
df_long <- recent_ratios |>
  rename('Whole' = WholeRatio,
         '1_Percent' = ReducedFat2Ratio,
         '2_Percent' = LowFat1Ratio,
         'Skim' = SkimRatio) |>
  pivot_longer(cols = c('Whole', '2_Percent' , '1_Percent', 'Skim'),
               names_to = "Milk_Type",
...
df_health <- data.frame(
  'Milk_Type' = c('Whole', '2_Percent' , '1_Percent', 'Skim'),
